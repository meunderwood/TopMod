...
{
    double thickness, shrinking_factor, rotation, panel_offset, panel_alternation_offset;
...
public:
    ...
    signals:
    void Apply(const std::vector<HALF_EDGE_MAPPING> &mapping_guid, const BranchCovering_CornerCutting_Parameters &parameters);
private slots:
